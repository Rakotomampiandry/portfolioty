...
export default function DetailService() {
    return (
        <div className="bg-gradient-to-r from-[#0D0716] to-[#000000] grid place-content-start pt-[2%] pb-[5%] md:pt-[3%]">
            <div className="hidden md:hidden lg:block bg-violeta bg-opacity-20 w-[3%] py-[1%] ml-[2%] rounded-full place-content-center place-items-center text-violeta cursor-pointer duration-200 hover:bg-opacity-30">
                <Linke to="/" className="place-content-center place-items-center flex">
                    <BiArrowBack className="text-[18px]" />
                </Linke>
            </div>

            <div className="bg-violeta bg-opacity-20 w-[10%] py-[2.5%] ml-[1%] rounded-full place-content-center place-items-center text-violeta cursor-pointer duration-200 hover:bg-opacity-30 md:w-[5%] md:ml-[2%] md:py-[1.5%] lg:hidden">
                <Linke to="/" className="place-content-center place-items-center flex">
                    <BiArrowBack className="text-[18px]" />
                </Linke>
            </div>
            ...
            <div className="w-[10vh] h-[2px] bg-white mx-auto bg-gradient-to-r from-[#9936AF] to-[#fff] mt-[5%] mb-[5%] rounded-xl lg:mt-[2%]"></div>
