          ...
          <div className="">
            <div className="px-[5%]">
              <div className="lg:text-left md:text-left">
                ...
                <p className="text-white text-center text-[12px] px-[2%] mt-[5%] md:text-[15px] md:px-0 md:pr-[35%] md:text-left md:mt-[2%] lg:text-[15px] lg:pr-[60%] lg:mt-[1%]">Développeur et designer, j’allie esthétique, stratégie et technologie pour donner vie à des projets modernes.</p>
              </div>

              <div className="mt-[20%] md:mt-[5%] lg:mt-[2%]">
