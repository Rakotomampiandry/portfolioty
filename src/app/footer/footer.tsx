  ...
  return (
    <footer  className="bg-gradient-to-r from-[#000000] to-[#0D0716] pt-[10%] md:pt-[5%]">
      <div className="">
        ...
        <p className="text-white opacity-80 justify-center text-center px-[15%] text-[14px] md:text-[15px] lg:px-[28%]">Passionné par le développement web et le design UI/UX, je mets mes compétences au service de projets innovants et modernes.</p>
